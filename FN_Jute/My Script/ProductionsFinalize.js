...
function GetFactoryUnit() {
    $.ajax({
        url: "Fn_Jute.aspx/GetFactoryUnit",
        data: JSON.stringify({}),
        type: "POST",
        async: false,
        dataType: "Json",
...
function topMainTablePrecision() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetAllDataforFinaligProduction",
        ...
        dataType: "json",
        success: function (data) {
            var PrecisionList = data.d.DailyPrecisionWindingProductionsList;
            ...
            PrecisionFooterTotal();

            $("input#T_Precision").val($("td.Precision_TotalPrdKgSum").text());
            $("input#T_Spinning").val($("td.Spinning_TotalPrdKgSum").text());
            $("input#T_Twisting").val($("td.Twisting_TotalPrdKgSum").text());
        },
        error: function (ex) {
...
//Top Main TableBody sum of Precision and Spinning and Twisting!
function PrecisionFooterTotal() {
    var GetProductionFinalligArry = ["Precision", "Spinning", "Twisting"];
    var changProductionFinalligClass = "";
    for (var i = 0; i < GetProductionFinalligArry.length; i++) {
        if (GetProductionFinalligArry[i] == "Precision") { changProductionFinalligClass = $("#TopMainTableBody tr.Precision") };
        ...
        var ShiftAHoursSum = 0, ShiftAMCSum = 0, ShiftASpandleSum = 0, ShiftAProductionSum = 0,
            ShiftBHoursSum = 0, ShiftBMCSum = 0, ShiftBSpandleSum = 0, ShiftBProductionSum = 0,
            ShiftCHoursSum = 0, ShiftCMCSum = 0, ShiftCSpandleSum = 0, ShiftCProductionSum = 0,
            ...
            ShiftAHours = 0, ShiftAMC = 0, ShiftASpandle = 0, ShiftAProduction = 0,
            ShiftBHours = 0, ShiftBMC = 0, ShiftBSpandle = 0, ShiftBProduction = 0,
            ShiftCHours = 0, ShiftCMC = 0, ShiftCSpandle = 0, ShiftCProduction = 0,
        ...
        changProductionFinalligClass.each(function () {
            ...
            ShiftAHoursSum += ShiftAHours; ShiftAMCSum += ShiftAMC; ShiftASpandleSum += ShiftASpandle; ShiftAProductionSum += ShiftAProduction;
            ShiftBHoursSum += ShiftBHours; ShiftBMCSum += ShiftBMC; ShiftBSpandleSum += ShiftBSpandle; ShiftBProductionSum += ShiftBProduction;
            ShiftCHoursSum += ShiftCHours; ShiftCMCSum += ShiftCMC; ShiftCSpandleSum += ShiftCSpandle; ShiftCProductionSum += ShiftCProduction;
...
function packingTable() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetAllDataforPackingtable",
        data: JSON.stringify({ date: date, Unit: Unit }),
        type: "POST",
        async: false,
        contentType: "application/json; charset=utf-8",
...
function loomTable() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetAllDataforLoomtable",
        data: JSON.stringify({ date: date, Unit: Unit }),
        type: "POST",
        async: false,
        contentType: "application/json; charset=utf-8",
...
function SummarySpinningTable() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetDepartmentType",
...
function SummaryLoomTable() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetDepartmentTypeL",
        data: JSON.stringify({ TblType: TblType }),
        type: "POST",
        async: false,
        contentType: "application/json; charset=utf-8",
...
function finalig() {
    ...
    //PrecisionArray
    $("#TopMainTableBody tr.Precision").each(function () {
        var PrecisionObj = {
            Unit: $("#FactorySelect option:selected").val(),
    ...
    $.ajax({
        url: "Fn_Jute.aspx/SaveFinalize",
        data: JSON.stringify({ aSTP: SPTArray, aPackingFinalize: PackingArray, aLoomFinalize: LoomArray, aSuSpinning: SummarySpining, aSuLoom: SummaryLoom, aPowerHistory: PowerHistory, aPowerHistoryLoom: PowerHistoryLoom, date: date, Unit: Unit, aDailyFinalize: DailyFinalize }),
        type: "POST",
        dataType: "Json",
        contentType: "application/json; charset=utf-8",
...
function GetSummarySpining() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetSummarySpining",
...
function GetSummaryLoom() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetSummaryLoom",
...
function GetPowerHistory() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetPowerHistory",
...
function GetPowerHistoryLoom() {
    ...
    $.ajax({
        url: "Fn_Jute.aspx/GetPowerHistoryLoom",
