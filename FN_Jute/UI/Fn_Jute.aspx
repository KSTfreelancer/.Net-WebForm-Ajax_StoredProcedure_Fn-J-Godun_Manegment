<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Fn_Jute.aspx.cs" Inherits="FN_Jute.UI.Fn_Jute" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Finalize_Box">
        <div class="Finalize_Box_top ">
            <p>Today Productions Finalize</p>
                        ...
                        <div class="summary_spining table-responsive table_maintenance tableStopScroll">
                            <table class="table table-bordered m-0">
                                ...
                                <tbody id="summary_spining_tbody">
                                    ...
                                    <tr>
                                        <td class="text-left">RC+FC+Dye</td>
                                        <td class="text-right">
                                            <input type="text" value="0" />
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td class="text-left">Mechanical</td>
                                        <td class="text-right">
                                            <input type="text" value="0" />
                                        </td>
                                        <td class="text-right">
                                ...
                                <tfoot id="summary_spining_tfoot">
                                    <%--<tr>
                                        <td class="text-left text-bold">Total Hands:</td>
                                        <td class="text-right">
                        ...
                        <div class="summary_loom table-responsive table_maintenance tableStopScroll">
                            <table class="table table-bordered m-0">
                                ...
                                <tbody id="summary_loom_tbody">
                                   <%-- <tr>
                                        <td class="text-left">Loom+Vim</td>
                                        <td class="text-right">
                                            <input type="text" value="0" />
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td class="text-left">Ha+CUTT+HAR</td>
                                        <td class="text-right">
                                            <input type="text" value="0" />
                                        </td>
                                        <td class="text-right">
                                ...
                                <tfoot id="summary_loom_tfoot">
                                    <%--<tr>
                                        <td class="text-left text-bold">Total Hands:</td>
                                        <td class="text-right">
                                            <input class="text-bold" type="text" value="0.0" />
                                        </td>
                                        <td class="text-right">
                                            <input class="text-bold" type="text" value="0.0" />
                                        </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Footer" runat="server">
    ...
    <script src="../My%20Script/ProductionsFinalize.js"></script>
